    ...
    fetch(`https://resources-cf.naranggo.com/version.json?ver=${ms}`)
      ...
      .then((json) => {
        ...
        if (
          ...
          json[Platform.OS.toUpperCase()]['StoreVersion'] &&
          json[Platform.OS.toUpperCase()]['StoreVersion'] > versionCode
        ) {
          setisUpdate(true);
          sendMessageToWeb(APP_TO_WEB_MESSAGE_TYPES.APP_IS_UPDATE, isUpdate);
        }
      ...
      {webviewURI && (
        <WebView
          ...
          source={{
            ...
            uri: `https://${webviewURI}/${
              isUpdate ? 'update' : notifictionPagePath
            }`
          }}
          onLoad={() => {
