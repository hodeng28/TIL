...
function ArLBSAFrame() {
  return (
    ...
    >
      <a-entity
        id="character-gps"
        character-gps={JSON.stringify(modelAvatar)}
        gps-new-entity-place="latitude: 37.4950; longitude: 127.1224"
      ></a-entity>
      <a-camera
        look-controls-enabled="false"
        arjs-device-orientation-controls="smoothingFactor:0.1"
        gps-new-camera="gpsMinDistance: 5; initialPositionAsOrigin: true"
      ></a-camera>
    </a-scene>
  );
}
